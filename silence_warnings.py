...
import os
os.environ['PYTHONWARNINGS']='ignore::DeprecationWarning,ignore:n_quantiles :UserWarning,ignore:Persisting input arguments took:UserWarning,ignore:Setting the eps parameter is deprecated and will be removed in 1.5. Instead eps will always havea default value of:FutureWarning'
